                        ...
                        <% } catch (PersistenciaException e) { out.println(e); } %>
                            ...
                            <%@include file="../header.jsp" %>
                                ...
                                <% int idEstadio=Integer.parseInt(request.getParameter("idEstadio")); String
                                    ...
                                    equipoEstadio=request.getParameter("equipoEstadio"); int
                                    ...
                                    nombreEstadio, equipoEstadio, capacidadEstadio, construccionEstadio); try {
                                    estadioController.modificarEstadio(estadio); } catch(PersistenciaException e) {
